...
import service.IGetCsvDataFromYahooService;

public class GetCsvDataFromYahooServiceImpl{
	...
	public static final String YAHOO_FINANCE_URL = "http://table.finance.yahoo.com/table.csv?";
	 ...
	 public GetCsvDataFromYahooServiceImpl() {
	  super();
	 }
	 
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	 }
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1, double y2) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	  this.y2 = y2;
	 } 
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1, double y2, double y3) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	  this.y2 = y2;
	 ...
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1, double y2, double y3,double y4) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	  this.y2 = y2;
	 ...
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1, double y2, double y3,double y4, double y5) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	  this.y2 = y2;
	 ...
	 public GetCsvDataFromYahooServiceImpl(Date x, double y1, double y2, double y3,double y4, double y5, double y6) {
	  super();
	  this.x = x;
	  this.y1 = y1;
	  this.y2 = y2;
...
//	       w->’周’(week)，m->’月’(mouth)，v->’dividends only’
	...
	//   j   52-week Low  年内最低价
	 ...
	 public static GetCsvDataFromYahooServiceImpl createObject(String line){
	  GetCsvDataFromYahooServiceImpl point = new GetCsvDataFromYahooServiceImpl();
	  int pos = 0;
	  String format = null;
	  String [] data = null;
	  if(line.indexOf(',') > 0){
	 ...
	 public static void main(String args[]) throws Exception{
	  ...
	  ArrayList  list = GetCsvDataFromYahooServiceImpl.getStockCsvData("399106.sz",185);
	  GetCsvDataFromYahooServiceImpl csvData = null;
	  for(int i = 0 ;i < list.size() ; i++){
	    csvData = (GetCsvDataFromYahooServiceImpl)list.get(i);
